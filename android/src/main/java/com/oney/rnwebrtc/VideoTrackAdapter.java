...
public class VideoTrackAdapter {
    ...
    public VideoTrackAdapter(WebRTCModuleImpl webRTCModuleImpl, int peerConnectionId) {
    ...
    private class TrackMuteUnmuteImpl implements VideoSink {
        ...
        TrackMuteUnmuteImpl(String trackId) {
            ...
            frameCounter = new AtomicInteger();
        }
        ...
        private void emitMuteEvent(boolean muted) {
            ...
            Log.d(TAG, (muted ? "Mute" : "Unmute") + " event peerConnectionId: " + peerConnectionId + " trackId: " + trackId);

            VideoTrackAdapter.this.webRTCModuleImpl.sendEvent("mediaStreamTrackMuteChanged", params);
        }
