...
class PeerConnectionObserver implements PeerConnection.Observer {
    ...
    private final Map<String, DataChannelObserver> dataChannels;
    ...
    PeerConnectionObserver(WebRTCModuleImpl webRTCModuleImpl, int id) {
        this.webRTCModuleImpl = webRTCModuleImpl;
        this.id = id;
        
        dataChannels = new HashMap<>();
        remoteStreamIds = new HashMap<>();
        remoteStreams = new HashMap<>();
        remoteTracks = new HashMap<>();
        videoTrackAdapters = new VideoTrackAdapter(webRTCModuleImpl, id);
    }
    ...
    void dispose() {
        ...
        for (DataChannelObserver dco : dataChannels.values()) {
            DataChannel dataChannel = dco.getDataChannel();
    ...
    WritableMap createDataChannel(String label, ReadableMap config) {
        ...
        DataChannelObserver dco = new DataChannelObserver(webRTCModuleImpl, id, reactTag, dataChannel);
        dataChannels.put(reactTag, dco);
        dataChannel.registerObserver(dco);
        ...
        info.putString("readyState", dco.dataChannelStateString(dataChannel.state()));

        return info;
    }

    void dataChannelClose(String reactTag) {
        DataChannelObserver dco = dataChannels.get(reactTag);
        if (dco == null) {
    ...
    void dataChannelSend(String reactTag, String data, String type) {
        ...
        dco.getDataChannel().send(buffer);
    }
    ...
    public void onIceCandidate(final IceCandidate candidate) {
        ...
        ThreadUtils.runOnExecutor(() -> {
            ...
            params.putInt("peerConnectionId", id);
            ...
            webRTCModuleImpl.sendEvent("peerConnectionGotICECandidate", params);
        });
    }
    ...
    public void onIceConnectionChange(PeerConnection.IceConnectionState iceConnectionState) {
        ThreadUtils.runOnExecutor(() -> {
            ...
            webRTCModuleImpl.sendEvent("peerConnectionIceConnectionChanged", params);
        });
    }
    ...
    public void onConnectionChange(PeerConnection.PeerConnectionState peerConnectionState) {
        ThreadUtils.runOnExecutor(() -> {
            ...
            webRTCModuleImpl.sendEvent("peerConnectionStateChanged", params);
        });
    }
    ...
    public void onIceGatheringChange(PeerConnection.IceGatheringState iceGatheringState) {
        ...
        ThreadUtils.runOnExecutor(() -> {
            ...
            webRTCModuleImpl.sendEvent("peerConnectionIceGatheringChanged", params);
        });
    }
    ...
    public void onDataChannel(DataChannel dataChannel) {
        ThreadUtils.runOnExecutor(() -> {
            ...
            webRTCModuleImpl.sendEvent("peerConnectionDidOpenDataChannel", params);
        });
    }
    ...
    public void onRenegotiationNeeded() {
        ThreadUtils.runOnExecutor(() -> {
            ...
            webRTCModuleImpl.sendEvent("peerConnectionOnRenegotiationNeeded", params);
        });
    }
    ...
    public void onSignalingChange(PeerConnection.SignalingState signalingState) {
        ThreadUtils.runOnExecutor(() -> {
            ...
            webRTCModuleImpl.sendEvent("peerConnectionSignalingStateChanged", params);
        });
    }
    ...
    public void onAddTrack(final RtpReceiver receiver, final MediaStream[] mediaStreams) {
        ...
        ThreadUtils.runOnExecutor(() -> {
            ...
            webRTCModuleImpl.sendEvent("peerConnectionOnTrack", params);
        });
    }
    ...
    public void onRemoveTrack(RtpReceiver receiver) {
        ThreadUtils.runOnExecutor(() -> {
            ...
            webRTCModuleImpl.sendEvent("peerConnectionOnRemoveTrack", params);
        });
    };
