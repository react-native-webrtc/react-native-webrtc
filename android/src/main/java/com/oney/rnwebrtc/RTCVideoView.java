...
public class RTCVideoView extends ViewGroup {
    /**
    ...
    private final RendererEvents rendererEvents = new RendererEvents() {
        ...
        public void onFirstFrameRendered() {
			RTCVideoView.this.onFirstFrameRendered();
        }

        @Override
        public void onFrameResolutionChanged(int videoWidth, int videoHeight, int rotation) {
			RTCVideoView.this.onFrameResolutionChanged(videoWidth, videoHeight, rotation);
        }
    };
