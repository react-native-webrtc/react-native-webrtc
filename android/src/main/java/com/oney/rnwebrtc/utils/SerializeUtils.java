package com.oney.rnwebrtc.utils;
...
public class SerializeUtils {
    ...
    public static ReadableMap serializeStream(int peerConnectionId, String streamReactTag, MediaStream stream) {
        WritableMap params = Arguments.createMap();
        ...
        for (VideoTrack track : stream.videoTracks) {
            tracks.pushMap(SerializeUtils.serializeTrack(peerConnectionId, track));
        }
    ...
    public static ReadableMap serializeTrack(int peerConnectionId, MediaStreamTrack track) {
        WritableMap trackInfo = Arguments.createMap();
        trackInfo.putString("id", track.id());
        trackInfo.putInt("peerConnectionId", peerConnectionId);
