...
public class H264AndSoftwareVideoDecoderFactory implements VideoDecoderFactory {
    ...
    public H264AndSoftwareVideoDecoderFactory(@Nullable EglBase.Context eglContext) {
        ...
        softwareVideoDecoderFactory = new SoftwareVideoDecoderFactoryProxy();
    }
    ...
    public VideoDecoder createDecoder(VideoCodecInfo codecInfo) {
        if (codecInfo.name.equalsIgnoreCase("H264")) {
            return hardwareVideoDecoderFactory.createDecoder(codecInfo);
        }

        return softwareVideoDecoderFactory.createDecoder(codecInfo);
    }
    ...
    public VideoCodecInfo[] getSupportedCodecs() {
        ...
        VideoCodecInfo[] hwCodecs = hardwareVideoDecoderFactory.getSupportedCodecs();
        ...
        codecs.addAll(Arrays.asList(softwareVideoDecoderFactory.getSupportedCodecs()));
